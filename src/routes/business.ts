...
export function registerBusinessRoutes(router: Router, container: AppContainer): void {
  ...
  router.get('/product-categories/:id', authenticate, requirePermissions('catalog.view'), asyncHandler(c.productCategoryController.getById));
  ...
  router.patch('/product-categories/:id', authenticate, requirePermissions('catalog.manage'), validate(updateProductCategorySchema), asyncHandler(c.productCategoryController.update));
  router.delete('/product-categories/:id', authenticate, requirePermissions('catalog.manage'), asyncHandler(c.productCategoryController.remove));
  ...
  router.get('/product-attributes/:id', authenticate, requirePermissions('catalog.view'), asyncHandler(c.productAttributeController.getById));
  ...
  router.patch('/product-attributes/:id', authenticate, requirePermissions('catalog.manage'), validate(updateProductAttributeSchema), asyncHandler(c.productAttributeController.update));
  router.delete('/product-attributes/:id', authenticate, requirePermissions('catalog.manage'), asyncHandler(c.productAttributeController.remove));
  ...
  router.get('/units/:id', authenticate, requirePermissions('catalog.view'), asyncHandler(c.unitController.getById));
  ...
  router.patch('/units/:id', authenticate, requirePermissions('catalog.manage'), validate(updateUnitSchema), asyncHandler(c.unitController.update));
  router.delete('/units/:id', authenticate, requirePermissions('catalog.manage'), asyncHandler(c.unitController.remove));
  ...
  router.get('/tax-masters/:id', authenticate, requirePermissions('catalog.view'), asyncHandler(c.taxMasterController.getById));
  ...
  router.patch('/tax-masters/:id', authenticate, requirePermissions('catalog.manage'), validate(updateTaxMasterSchema), asyncHandler(c.taxMasterController.update));
  router.delete('/tax-masters/:id', authenticate, requirePermissions('catalog.manage'), asyncHandler(c.taxMasterController.remove));
  ...
  router.get('/suppliers/:id', authenticate, requirePermissions('supplier.view'), asyncHandler(c.supplierController.getById));
  ...
  router.patch('/suppliers/:id', authenticate, requirePermissions('supplier.manage'), validate(updateSupplierSchema), asyncHandler(c.supplierController.update));
  router.delete('/suppliers/:id', authenticate, requirePermissions('supplier.manage'), asyncHandler(c.supplierController.remove));
  ...
  router.get('/customer-groups/:id', authenticate, requirePermissions('customer.view'), asyncHandler(c.customerGroupController.getById));
  ...
  router.patch('/customer-groups/:id', authenticate, requirePermissions('customer.manage'), validate(updateCustomerGroupSchema), asyncHandler(c.customerGroupController.update));
  router.delete('/customer-groups/:id', authenticate, requirePermissions('customer.manage'), asyncHandler(c.customerGroupController.remove));
  ...
  router.get('/customers/:id', authenticate, requirePermissions('customer.view'), asyncHandler(c.customerController.getById));
  ...
  router.patch('/customers/:id', authenticate, requirePermissions('customer.manage'), validate(updateCustomerSchema), asyncHandler(c.customerController.update));
  router.delete('/customers/:id', authenticate, requirePermissions('customer.manage'), asyncHandler(c.customerController.remove));
  ...
  router.get('/products/:id', authenticate, requirePermissions('catalog.view'), asyncHandler(c.productController.get));
  ...
  router.patch('/products/:id', authenticate, requirePermissions('catalog.manage'), validate(updateProductSchema), asyncHandler(c.productController.update));
  router.delete('/products/:id', authenticate, requirePermissions('catalog.manage'), asyncHandler(c.productController.remove));
  ...
  router.get('/product-variants/:id', authenticate, requirePermissions('catalog.view'), asyncHandler(c.productVariantController.get));
  ...
  router.patch('/product-variants/:id', authenticate, requirePermissions('catalog.manage'), validate(updateProductVariantSchema), asyncHandler(c.productVariantController.update));
  router.delete('/product-variants/:id', authenticate, requirePermissions('catalog.manage'), asyncHandler(c.productVariantController.remove));
  ...
  router.get('/inventories/value', authenticate, requirePermissions('inventory.view'), asyncHandler(c.inventoryController.value));
  router.get('/inventories/low-stock', authenticate, requirePermissions('inventory.view'), asyncHandler(c.inventoryController.lowStock));
  router.get('/inventories/:id', authenticate, requirePermissions('inventory.view'), asyncHandler(c.inventoryController.getById));
  ...
  router.get('/stock-movements/:id', authenticate, requirePermissions('inventory.view'), asyncHandler(c.stockMovementController.getById));
  ...
  router.get('/opening-stocks/:id', authenticate, requirePermissions('inventory.view'), asyncHandler(c.openingStockController.getById));
  ...
  router.post('/opening-stocks/:id/post', authenticate, requirePermissions('inventory.manage'), asyncHandler(c.openingStockController.post));
  router.delete('/opening-stocks/:id', authenticate, requirePermissions('inventory.manage'), asyncHandler(c.openingStockController.remove));
  ...
  router.get('/purchases/:id', authenticate, requirePermissions('purchase.view'), asyncHandler(c.purchaseController.getById));
  ...
  router.patch('/purchases/:id', authenticate, requirePermissions('purchase.manage'), validate(updatePurchaseSchema), asyncHandler(c.purchaseController.update));
  router.post('/purchases/:id/receive', authenticate, requirePermissions('purchase.manage'), asyncHandler(c.purchaseController.receive));
  router.delete('/purchases/:id', authenticate, requirePermissions('purchase.manage'), asyncHandler(c.purchaseController.remove));
  ...
  router.get('/purchase-returns/:id', authenticate, requirePermissions('purchase.view'), asyncHandler(c.purchaseReturnController.getById));
  ...
  router.patch('/purchase-returns/:id', authenticate, requirePermissions('purchase.manage'), validate(updatePurchaseReturnSchema), asyncHandler(c.purchaseReturnController.update));
  router.post('/purchase-returns/:id/complete', authenticate, requirePermissions('purchase.manage'), asyncHandler(c.purchaseReturnController.complete));
  router.delete('/purchase-returns/:id', authenticate, requirePermissions('purchase.manage'), asyncHandler(c.purchaseReturnController.remove));
  ...
  router.get('/sales/:id', authenticate, requirePermissions('sales.view'), asyncHandler(c.saleController.getById));
  ...
  router.patch('/sales/:id', authenticate, requirePermissions('sales.manage'), validate(updateSaleSchema), asyncHandler(c.saleController.update));
  router.post('/sales/:id/complete', authenticate, requirePermissions('sales.manage'), validate(completeSaleSchema), asyncHandler(c.saleController.complete));
  router.delete('/sales/:id', authenticate, requirePermissions('sales.manage'), asyncHandler(c.saleController.remove));
  ...
  router.get('/hold-bills/:id', authenticate, requirePermissions('sales.view'), asyncHandler(c.holdBillController.getById));
  ...
  router.post('/hold-bills/:id/resume', authenticate, requirePermissions('sales.manage'), validate(resumeHoldSchema), asyncHandler(c.holdBillController.resume));
  router.post('/hold-bills/:id/cancel', authenticate, requirePermissions('sales.manage'), asyncHandler(c.holdBillController.cancel));
  ...
  router.get('/payments/:id', authenticate, requirePermissions('sales.view'), asyncHandler(c.paymentController.getById));
  ...
  router.delete('/payments/:id', authenticate, requirePermissions('sales.manage'), asyncHandler(c.paymentController.remove));
  ...
  router.get('/business-settings/:id', authenticate, requirePermissions('settings.view'), asyncHandler(c.businessSettingController.getById));
  ...
  router.patch('/business-settings/:id', authenticate, requirePermissions('settings.manage'), validate(updateBusinessSettingSchema), asyncHandler(c.businessSettingController.update));
  router.delete('/business-settings/:id', authenticate, requirePermissions('settings.manage'), asyncHandler(c.businessSettingController.remove));

  // Receipt Settings
  router.get('/receipt-settings', authenticate, requirePermissions('settings.view'), asyncHandler(c.receiptSettingController.get));
  ...
  router.delete('/receipt-settings', authenticate, requirePermissions('settings.manage'), asyncHandler(c.receiptSettingController.remove));
}
